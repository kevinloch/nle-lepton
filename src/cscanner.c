                ...
                if (gcd(u, v) == 1) {
                  ...
                  for (outfactor=0; outfactor < nle_state->outfactors_precomputed_count; outfactor++) {
                    ...
                    for (infactor=0; infactor < nle_state->infactors_precomputed_count; infactor++) { 
                      ...
                      if ((nle_state->term1.smrfactor_1minus == 0) || (mass_ratio_id == nle_state->term1.smrfactor_mass)) {
                      ...
                      if ((nle_config->nle_mode == 3) || ((nle_config->nle_mode == 2) && (mass_ratio_id == 1) && (infactors->infactor_nss == 0) && (infactors->infactor_nbv == 0)\
