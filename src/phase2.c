                      ...
                      for (muser_seq=(!nle_state->all_uses.m_user || nle_state->all_uses.float_muser || (nle_config->smrfactor_mass_user_error == 0)); muser_seq <= 1; muser_seq++) {
                        ...
                        for (samples=0; (precision_last > precision_target); samples++) {
                          ...
                          if (nle_state->all_uses.float_alpha_em == 1) {
                            ...
                            i=0;
                            while ((alpha < nle_config->ref_alpha_em * 0.8) || (alpha > (nle_config->ref_alpha_em * 1.2))) { // sanity check on alpha to help solve correct root and speed convergance
                          ...
                          if (nle_state->all_uses.float_sm1 == 1) {
                            ...
                            i=0;
                            while ((sm1 < nle_config->ref_sm1 * 0.8) || (sm1 > (nle_config->ref_sm1 * 1.2))) { // sanity check on sm1 mass to help solve correct root and speed convergance
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_sm2 == 1) {
                            ...
                            i=0;
                            while ((sm2 < nle_config->ref_sm2 * 0.8) || (sm2 > (nle_config->ref_sm2 * 1.2))) { // sanity check on sm2 mass to help solve correct root and speed convergance
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_v == 1) {
                            ...
                            i=0;
                            while ((v < (nle_config->ref_v * 0.8)) || (v > (nle_config->ref_v * 1.2))) { // sanity check to help convergance
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_mz == 1) {
                            ...
                            i=0;
                            while ((mz < nle_config->ref_mz * 0.8) || (mz > (nle_config->ref_mz * 1.2))) { // sanity check on mz mass to help solve correct root and speed convergance
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_G == 1) {
                            ...
                            i=0;
                            while ((G < (nle_config->ref_G * 0.8)) || (G > (nle_config->ref_G * 1.2))) {  // sanity check to help convergance
                              if (i > 50) {  // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_sm3 == 1) {
                            ...
                            i=0;
                            while ((sm3 < nle_config->ref_sm3 * 0.8) || (sm3 > (nle_config->ref_sm3 * 1.2))) { // sanity check on sm3 mass to help solve correct root and speed convergance
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_mw == 1) {
                            ...
                            i=0;
                            while ((mw < nle_config->ref_mw * 0.8) || (mw > (nle_config->ref_mw * 1.2)) || (mw >= mz)) { // sanity check on mw mass to help solve correct root and speed convergance and prevent mw >= mz
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_sin2w == 1) {  
                            ...
                            i=0;
                            while ((sin2w < nle_config->ref_sin2w * 0.8) || (sin2w > (nle_config->ref_sin2w * 1.2))) { // sanity check on sin2w to help solve correct root and speed convergance
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_mh0 == 1) {
                            ...
                            i=0;
                            while ((mh0 < nle_config->ref_mh0 * 0.8) || (mh0 > (nle_config->ref_mh0 * 1.2))) { // sanity check on mh0 mass to help solve correct root and speed convergance
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
                          ...
                          if (nle_state->all_uses.float_muser == 1) {
                            ...
                            i=0;
                            while ((muser < nle_config->smrfactor_mass_user * 0.8) || (muser > (nle_config->smrfactor_mass_user * 1.2))) { // sanity check on m_user mass to help solve correct root and speed convergance
                              if (i > 50) { // safety valve in case search gets out of bounds
#ifdef DEBUG20
                                clock_gettime(CLOCK_REALTIME, &end_time);
                                elapsed_time=((double)(end_time.tv_sec - 1500000000) + ((double)end_time.tv_nsec / 1.0E9)) - ((double)(start_time2.tv_sec - 1500000000) + ((double)start_time2.tv_nsec) / 1.0E9);
